...
// <ZT_CODE_INJECTION>// </ZT_CODE_INJECTION>
...
// <ZT_CODE_INJECTION>
typedef enum {
    ZT_SENSOR_DATA_CHANNEL,
    ZT_WHEEL_DATA_CHANNEL,
    ZT_REQUEST_CHANNEL,
    ZT_CHARGE_REQUEST_CHANNEL,
    ZT_RUNNING_CHANNEL,
    ZT_CHANNEL_COUNT
...
extern zt_service_t SENSOR_service;
...
/* BEGIN TWO_WHEEL SECTION */
extern zt_service_t TWO_WHEEL_service;
#define TWO_WHEEL_TASK_PRIORITY 4
#define TWO_WHEEL_STACK_SIZE 256
/* END TWO_WHEEL SECTION */

/* BEGIN NET SECTION */
extern zt_service_t NET_service;
#define NET_TASK_PRIORITY 6
#define NET_STACK_SIZE 256
/* END NET SECTION */
// </ZT_CODE_INJECTION>
